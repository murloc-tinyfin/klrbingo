...
<p>
The rules are also provided under the bingo cards, but if you wanna read them here instead, we got you.
<ol>
  <li>
    You have to gain 300 XP on top of the XP you already have on the leaderboard for each card that contains that space. When you achieve the 300 XP, you must announce it to the chat.
  </li>
  <li>
    For the 'matching theme' space, if a song from a game plays while that game is in the gameplay corner it checks that space, it doesn't have to be the specific song matching the level of the gameplay.
  </li>
  <li>
    For the 'specific song' category, remixes are allowed, but it has to be an individual remix, not a medley.
  </li>
  <li>
    One exception to the "no medley" rule is the Morpho Knight Dream Friend boss fight themes from Kirby Star Allies, they always count.
  </li>
  <li>
    Songs from remakes of games count for the original game, so a Kirby’s Adventure track counts for Kirby Nightmare In Dream Land and vice versa.
  </li>
  <li>
    If you feel like something's unclear you can decide how to interpret it yourself, the rules section will miss edge cases that we did not think of.
  </li>
  <li>
    If there are any questions or concerns let us know. Suggestions for bingo spaces are also accepted.
  </li>
  <li>
